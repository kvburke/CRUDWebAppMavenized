...
public class StudentController {
	...
	@RequestMapping(value = "/stats", method= RequestMethod.GET, headers="Accept=application/xml, application/json")
			public @ResponseBody List getlist2(HttpServletResponse response2) {
					return studentService.getAllStat();
